...
namespace TelerikControles.Models
{
    ...
    public partial class AdventureWorksEntities1 : DbContext
    {
        public AdventureWorksEntities1()
            : base("name=AdventureWorksEntities1")
        {
        }
        ...
        [DbFunction("AdventureWorksEntities1", "ufnGetContactInformation")]
        public virtual IQueryable<ufnGetContactInformation_Result> ufnGetContactInformation(Nullable<int> personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetContactInformation_Result>("[AdventureWorksEntities1].[ufnGetContactInformation](@PersonID)", personIDParameter);
        }
